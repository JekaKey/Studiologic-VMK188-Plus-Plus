...
static json_attr_t preset_attr[21] = {
		...
		{ATTR_MO, t_object, .addr.object = mod_param_attr},
...
static void init_json_calibr_attr(calibrationType *cal) {
	for (uint8_t i = 0; i < SLIDERS_AMOUNT; i++){
