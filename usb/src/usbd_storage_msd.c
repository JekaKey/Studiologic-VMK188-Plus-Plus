...
const int8_t  STORAGE_Inquirydata[] = {//36
  ...
  0x00,	
  0x00,
  'N', 'e', 'k', 't', 'o', ' ', ' ', ' ', /* Manufacturer : 8 bytes */
  'V', 'M', 'K', '1', '8', '8', '+', '+', /* Product      : 16 Bytes */
  ' ', 'S', 'D', 'c', 'a', 'r', 'd', ' ',
...
int8_t STORAGE_GetCapacity (uint8_t lun, uint32_t *block_num, uint32_t *block_size)
{
  ...
  *block_size =  512;//SDCardInfo.CardBlockSize;
  *block_num =  SDCardInfo.CardCapacity / 512; //SDCardInfo.CardBlockSize;
